...
- **Java 17** (compatível com Java 17 ou superior)
...
│   │   ├── DataMock.java               # Dados de teste para execução manual
│   │   └── services/
│   │       ├── StudentService.java
│   │       ├── PlanService.java
...
> ```cmd
> javac -d out src\FitManagerApp.java src\application\*.java src\application\services\*.java src\domain\model\*.java src\domain\enums\*.java src\ui\screen\*.java src\ui\menus\main\*.java src\ui\menus\student\*.java src\ui\menus\plan\*.java src\ui\menus\enrollment\*.java src\ui\menus\reports\*.java
> ```
...
Java 17 (versão mínima exigida pelo projeto)

> O projeto foi desenvolvido e testado com Java 25.0.1 (LTS). Qualquer versão igual ou superior a 17 é compatível.
